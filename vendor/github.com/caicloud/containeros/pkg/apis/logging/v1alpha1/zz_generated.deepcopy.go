...
import (
	metav1 "github.com/caicloud/api/meta/v1"
	v1beta1 "github.com/elastic/cloud-on-k8s/pkg/apis/beat/v1beta1"
...
func (in *FilebeatTemplate) DeepCopyInto(out *FilebeatTemplate) {
	*out = *in
	if in.Metadata != nil {
		...
		*out = new(metav1.EmbeddedObjectMeta)
		(*in).DeepCopyInto(*out)
	}
	if in.Spec != nil {
		in, out := &in.Spec, &out.Spec
		*out = new(v1beta1.BeatSpec)
		(*in).DeepCopyInto(*out)
	}
	return
}
