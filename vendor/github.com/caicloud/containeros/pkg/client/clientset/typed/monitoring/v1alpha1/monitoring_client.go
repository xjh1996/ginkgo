...
type MonitoringV1alpha1Interface interface {
	...
	PrometheusClusterSetsGetter
}

// MonitoringV1alpha1Client is used to interact with features provided by the monitoring.containeros.dev group.
type MonitoringV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MonitoringV1alpha1Client) PrometheusClusterSets(namespace string) PrometheusClusterSetInterface {
	return newPrometheusClusterSets(c, namespace)
}
